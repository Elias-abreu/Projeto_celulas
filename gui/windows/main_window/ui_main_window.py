...
class UI_MainWindow(object):
    def setup_ui(self, parent):
        ...
        self.btn_2 = PyPushButton(
            text = "Classificação",
            icon_path = "icon_pasta.svg"
        )
        self.btn_3 = PyPushButton(

            text = "Treinamento",
            icon_path="icon_loop_circular.svg"
        )
        ...
        # Left label
        self.top_label_left = QLabel("PRIMEIRO TESTE PROJETO IA")
        ...
        # Left label
        self.bottom_label_left = QLabel("Criado por: EQUIPE IA")
