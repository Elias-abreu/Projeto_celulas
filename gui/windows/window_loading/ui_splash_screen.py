...
"color: rgb(155, 155, 255);")
    ...
    def retranslateUi(self, SplashScreen):
        ...
        self.labelTitle.setText(QCoreApplication.translate("SplashScreen", u"<html><head/><body><p><span style=\" font-weight:600; color:#9b9bff;\">BETA</span> PROJETO IA</p></body></html>", None))
        ...
        self.labelLoadingInfo.setText(QCoreApplication.translate("SplashScreen", u"carregando...", None))
        self.labelCredits.setText(QCoreApplication.translate("SplashScreen", u"Criadores: Equipe IA", None))
    # retranslateUi
